    ...
    <section class="card1 center">
        ...
        <form id="forgotForm">
            ...
            <section class="form">
                ...
                <input class="center flex roboto-thin" type="text" name="password" placeholder="Password" required>
                <input class="center flex roboto-thin" type="text" name="cpassword" placeholder="Confirm Password" required>
            ...
            $.ajax({
              ...
              beforeSend: function()
              {
                ...
                success: function(response) {
                    ...
                    if(response==200)
                      {
                         $('.status_msg').html('<p class="alert alert-success">Password Reset Successfully....!</p>');
                         setTimeout(function() {
